 ...
 *
 */
public class SildingLinearLayout extends LinearLayout implements
        OnTouchListener {
    /**
    ...
    public SildingLinearLayout(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public SildingLinearLayout(Context context, AttributeSet attrs, int defStyle) {
